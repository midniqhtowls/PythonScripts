...
activity=discord.Activity(type=discord.ActivityType.watching, name=f"{status}", # sets watching status, if you want to change the thing your bot is watching then change the status part
